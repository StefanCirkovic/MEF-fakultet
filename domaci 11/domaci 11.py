...
first = int(input("Enter the score for the first exam: "))
second = int(input("Enter the score for the second exam: "))
third = int(input("Enter the score for the third exam: "))
insert(name, first, second, third)
